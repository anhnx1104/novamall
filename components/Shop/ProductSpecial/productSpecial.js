...
import c from "./productSpecial.module.css";
...
const ProductSpecial = ({
  ...
  return (
    <Link href={`/product/${product.slug}`}>
      <div
        className={`${c.item} ${ItemLayout} ${product.isSpecial && c.special}`}
        style={{ minWidth: size || "216px", maxWidth: size || "216px" }}
      >
        <div className={c.bg1}>
          <div className={c.bg2}>
            <div className={c.bg3}>
