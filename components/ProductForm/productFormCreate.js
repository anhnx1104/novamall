...
const ProductFormCreate = () => {
  ...
  return (
    <>
      <h4 className="text-center pt-3 pb-5">{t("특별 상품 생성")}</h4>
      <form
        id="product_form"
        ...
        <div className="card-body">
          <div className="row">
            <div className="col-md-3">
              ...
              >
                <label htmlFor="inp-110" className="form-label mb-0">
                  {t("new_product")}
                </label>
                ...
                <Switch
                  id="inp-110"
                  name="new_product"
                  inputProps={{ "aria-label": "Switch for new product" }}
                />
              </div>
            </div>
            <div className="col-md-3">
              ...
              >
                <label htmlFor="inp-111" className="form-label mb-0">
                  {t("trending_product")}
                </label>
                ...
                <Switch
                  id="inp-111"
                  name="trending"
                  inputProps={{ "aria-label": "Switch for trending product" }}
                />
              </div>
            </div>
            <div className="col-md-3">
              ...
              >
                <label htmlFor="inp-112" className="form-label mb-0">
                ...
                <Switch
                  id="inp-112"
                  name="best_selling"
                  inputProps={{ "aria-label": "Switch for best selling product" }}
                />
              </div>
            </div>
            {/* select */}
          ...
          <div className="col-12">
            <div className="py-3">
              ...
              <FormControl fullWidth required size="small">
                <InputLabel id="inp-type-label">{t("Select Product Type")}</InputLabel>
                <Select
                  labelId="inp-type-label"
                  id="inp-type"
                  value={selectedType}
                ...
                >
                  ...
                  <MenuItem value="simple">기본 상품</MenuItem>
                  <MenuItem value="variable">옵션 상품</MenuItem>
                </Select>
              </FormControl>
