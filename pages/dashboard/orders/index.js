...
const OrderPage = () => {
  ...
  const deleteOrder = async () => {
    ...
    await deleteData(`/api/order?id=${selectedOrder}`)
      .then((data) =>
        data.success
          ? (toast.success("주문이 성공적으로 삭제되었습니다."), mutate())
  ...
  const handlePaymentStatus = async (e, orderStatus, id) => {
    ...
    await updateData(url)
      .then((data) =>
        data.success
          ? (toast.success("주문 결제 상태가 성공적으로 업데이트되었습니다."),
            mutate())
          : toast.error("문제가 발생했습니다.")
      )
      .catch((err) => {
      ...
      selector: (row) =>
        permissions.edit ? (
          <div className="dropdown">
            ...
            >
              <option value="Paid">지불</option>
              <option value="Unpaid">미지불</option>
            </select>
          </div>
        ) : (
        ...
        permissions.edit ? (
          <div className="dropdown">
            ...
            >
              ...
              <option value="Packaged">포장됨</option>
