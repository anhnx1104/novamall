              ...
              <div>
                <div className={`${classes.order_details} row`}>
                  <div className="col-md-6">
                    ...
                    <p>
                      ...
                      {orderData.paymentStatus === "Unpaid" ? (
                        <span className="badge bg-danger">미결제</span>
                      ) : (
                        <span className="badge bg-success">결제</span>
                      )}
                    </p>
                    <p>
                      {t("order_status")} :{" "}
                  ...
                  <div className="col-md-6">
                    ...
                    <p>
                      {t("delivery_type")} :{" "}
                      <span>
                        {translateDeliveryType(orderData.deliveryInfo.type)}
                      </span>
                    </p>
                    ...
                    <tbody>
                      {orderData.products.map((product, idx) => (
                        <tr key={idx}>
                          ...
                          <td>
                            {currencySymbol +
                              formatNumberWithCommaAndFloor(product.price)}
                          </td>
                        </tr>
                      ))}
                    </tbody>
                ...
                <div className={classes.payment_info}>
                  <div>
                    ...
                    <span>
                      {currencySymbol +
                        formatNumberWithCommaAndFloor(orderData.totalPrice)}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span>
                      {currencySymbol}
                      {formatNumberWithCommaAndFloor(orderData.vat || 0, 2)}
                    </span>
                  </div>
                  <div>
                    <span>{t("tax")}</span>
                    <span>
                      {currencySymbol}
                      {formatNumberWithCommaAndFloor(orderData.tax || 0, 2)}
                    </span>
                  </div>
                  <div>
                    <span>{t("total")}</span>
