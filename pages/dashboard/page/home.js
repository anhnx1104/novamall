...
const HomePageSetting = () => {
  ...
  const deleteCarouselItem = async () => {
    ...
    await deleteData(`/api/page/home?id=${selectedId}&scope=carousel`)
      .then((data) =>
        data.success
          ? (toast.success("항목이 성공적으로 삭제되었습니다."), mutate())
  ...
  const handleCarouselAdd = async (e) => {
    ...
    try {
      ...
      success
        ? (toast.success("항목이 성공적으로 추가되었습니다."),
  ...
  const handleCarouselBackground = async () => {
    try {
      ...
      success
        ? toast.success("배경 이미지가 성공적으로 추가되었습니다.")
        : toast.error(err);
      setButtonState("");
    } catch (err) {
      setButtonState("");
  ...
  const handleBannerAdd = async (e) => {
    ...
    try {
      ...
      success
        ? toast.success("배너가 성공적으로 업데이트되었습니다.")
        : toast.error(err);
      setButtonState("");
    } catch (err) {
      setButtonState("");
